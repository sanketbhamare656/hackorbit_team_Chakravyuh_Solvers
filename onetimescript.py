        ...
        try:
            if not self.check_file_existence():
                return {
                    ...
                    'ERROR',
                    'msg':
                    "File does not exist. Please add file at " + self.file_path
                }
            ...
            with open(self.file_path, newline='') as csvfile:
                ...
                for row in reader:
                    ...
                    domain_data_dict[row[1]] = row[
                        0]  # saving domain : rank to dict
            ...
            return {
                'status': 'SUCCESS',
                'msg':
                'Execution Time: ' + str(round(end - start, 2)) + ' seconds'
            }
